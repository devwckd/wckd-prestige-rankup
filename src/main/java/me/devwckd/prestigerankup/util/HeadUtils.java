...
public class HeadUtils {
    ...
    private static final Method REMOVE_ALL_METHOD = getReflectionDeclaredMethod(PROPERTY_MAP_CLASS, "removeAll", String.class);
    private static final Method PUT_METHOD = getReflectionDeclaredMethod(PROPERTY_MAP_CLASS, "put", PROPERTY_CLASS);
    private static final Field PROFILE_FIELD = getReflectionDeclaredField(SkullMeta.class, "profile");
    ...
    public static ItemStack injectSkin(ItemStack stack, String skin) {
        ...
        if(PROFILE_FIELD == null) throw new NullPointerException("profileField cannot be null!");
        ...
        invokeReflectionMethod(PUT_METHOD, propertyObject, propertyObject);

        SkullMeta skullMeta = ((SkullMeta) stack.getItemMeta());
        setReflectionFieldAccessible(PROFILE_FIELD, true);
        setReflectionField(PROFILE_FIELD, skullMeta, gameProfileObject);
        setReflectionFieldAccessible(PROFILE_FIELD, false);
